...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        if (requestCode == SELECT_GPX_FILE && resultCode == RESULT_OK) { // If a file was selected
            Uri uri = null;
            if (resultData != null) {
    ...
    private class SendDataTask extends AsyncTask<String, Void, Pair<String, String>> {
        ...
        protected void onPostExecute(Pair<String, String> resultPair) {
            if (resultPair != null && resultPair.second != null) {
                ...
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MainActivity.this);
                preferences.edit().putString("username", resultPair.first).apply(); // Save the username in SharedPreferences

                showNotification(result);

                MainActivity.this.username = resultPair.first; // Update the username
    ...
    private void showNotification(String result) {
        try {
            ...
            NotificationManagerCompat notificationManager = NotificationManagerCompat.from(this);// Get an instance of the NotificationManager service

            notificationManager.notify(1, builder.build());// Build the notification and display it
